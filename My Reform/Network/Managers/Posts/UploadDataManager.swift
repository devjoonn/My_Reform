...
class UploadDataManager{
    ...
    static func posts(_ viewController: UploadViewController,_ parameter: UploadInput ,images: [UIImage]) {
        ...
        }, to: "\(Constants.baseURL)/boards/create", usingThreshold: UInt64.init(), method: .post, headers: Headers).validate(statusCode: 200..<500).responseDecodable(of: CUDModel.self)
        { response in
